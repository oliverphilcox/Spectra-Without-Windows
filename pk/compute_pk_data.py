...
data = load_data(sim_no,ZMIN,ZMAX,patch=patch,cosmo_coord,fkp_weights=False);
randoms = load_randoms(sim_no,ZMIN,ZMAX,patch=patch,cosmo_coord,fkp_weights=False);
