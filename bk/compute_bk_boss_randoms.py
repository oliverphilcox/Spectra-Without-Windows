...
if wtype==0:
    ...
    Cinv_diff = applyCinv(diff,nbar_weight,MAS_mat,pk_map,Y_lm,k_grids,r_grids,v_cell,shot_fac,rel_tol=1e-6,verb=1,max_it=30,include_pix=include_pix)
...
del all_g_a, all_tilde_g_a, k_norm
